                        ...
                        <div class="col-12 flex flex-wrap">
                            ...
                            <div class="col-6 br-top" v-if="show">
                                ...
                                <div class="pad">
                                    ...
                                    <div class="green-bold">Больше всего в: <span v-html="max_id"></span> ( <span v-html="max"></span> овец)</div>   
                                    <div class="green-bold">Меньше всего в: <span v-html="min_id"></span> ( <span v-html="min"></span> овец)</div>                                    
                                </div>
        ...
        new Vue({
            ...
            methods: {
                ...
                max_min(){
                    ...
                    temp=this.zagons[this.zagons.length-1];
                    array=[temp.zagon1,temp.zagon2,temp.zagon3,temp.zagon4];                    
                    for (i=0;i<array.length;i++){
                        if(max<array[i]){
                            max=array[i];
                            id=i;
